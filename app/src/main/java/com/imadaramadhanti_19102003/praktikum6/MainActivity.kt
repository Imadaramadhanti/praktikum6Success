...
import com.imadaramadhanti_19102003.praktikum6.adapter.CardViewMyDataAdapter
import com.imadaramadhanti_19102003.praktikum6.adapter.GridMyDataAdapter
import com.imadaramadhanti_19102003.praktikum6.adapter.ListMyDataAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    fun getListMyDatas(): ArrayList<MyData> {
        ...
        for (position in dataName.indices) {
            val myData = MyData(dataName[position],
